...
> Generated by `nuxt-frontend-design`. This file captures the *intent* behind design decisions so future work stays cohesive across conversations, contributors, and skills. Compatible with the `@google/design.md` linter.
>
