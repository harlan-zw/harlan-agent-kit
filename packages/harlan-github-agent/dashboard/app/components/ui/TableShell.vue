...
import type { UiTableSize } from '../../utils/table.ts'

/** Port of nuxtseo design-system UiTableShell: a `<table>` inside the frame, with head, body, and foot slots. */
const {
  size = 'md',
  rowHover = false,
  bordered = false,
  ...
  size?: UiTableSize
  /** Enable hover tint on body rows. */
  rowHover?: boolean
